      ...
      <div className="flex flex-row justify-center bg-gray-100" id="review">
        ...
        <div className="flex flex-col">
          <div className="mt-12">
            ...
            <p></p>Mr. Ashish Kumar Patel has 18+ Years of expertise<br></br> in teaching and mentoring more than 250+ Students <br></br>to make an expert in their career.

He has worked with<br></br> big giants like Microsoft, Samsung, Intel, Blackberry, etc<br></br> in his career span.<br></br>
